...
use SpoiledCar\FrontOfficeBundle\Entity\Marque;
use SpoiledCar\FrontOfficeBundle\Form\MarqueType;
...
class MarqueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $marques = $em->getRepository('SpoiledCarFrontOfficeBundle:Marque')->findAll();
    ...
    {
        $marque = new Marque();
        $form = $this->createForm('SpoiledCar\FrontOfficeBundle\Form\MarqueType', $marque);
    ...
    {
        $deleteForm = $this->createDeleteForm($marque);
        $editForm = $this->createForm('SpoiledCar\FrontOfficeBundle\Form\MarqueType', $marque);
